...
public class TeacherControllerIT {
    ...
    void shouldDeleteTeacherLogically() throws Exception {
        ...
        Teacher checkedTeacher = teacherRepository.findById(savedTeacherId).orElse(null);
        assertThat(checkedTeacher).isNotNull();
        assertThat(checkedTeacher.isDeleted()).isTrue();
    }
}